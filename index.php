...
<body>
		...
		<div class="container">
			<div class="navbar-header nabar-left">
				...
				<a class="navbar-brand" href="">
					<img src="logo_icon.png" width="50" height="50" style="margin-top:-15px">
				</a> 
			</div>
	...
	<div class="jumbotron">
		<div class="container">
			<div class="transbox">
				<h1><?php if(isset($_SESSION['login_MEMBERID'])) print 'Welcome '.$_SESSION['login_FIRSTNAME'].". ";?>Find a place to stay in Atlanta.</h1>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-sm-6">
				<h3>Welcome!</h3>
				<p style="opacity:">Find the perfect home for you and your family. Meet home owners who are searching for you, or you search for them. With millions of people subscribed to our service, we at skanda are trying our best to put smiles on everyone's face.</p>
			</div>
			<div class="col-md-4 col-sm-6">
				<?php
				if(isset($_SESSION['login_MEMBERID'])){
					...
					print '
					<h3>What is skanda?</h3>
					<p>skanda is a place where tenants and home owners create a trusting relationship to sleep soundly in their own beds.</p>
					';
				}
				?>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-10  col-md-offset-1 text-center">
					<h3>Contact</h3>
					<p><small> <strong>Sandeep</strong><br>
				...
				<p class="text-center col-md-12"r style="padding-top: 30px">
					<small>© Copyright Sandeep. All rights reserved.</small>
				</p>
			</div>
		</footer>
